    ...
    if (function_exists('vc_add_params')) {
        ...
        vc_map(array(
            ...
            'params' => array(
                ...
                array(
                    'type' => 'stm_wcmap_autocomplete_vc_taxonomies',
...
if (class_exists('WPBakeryShortCode')) {
    class WPBakeryShortCode_STM_WCMAP_Category_Megamenu extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_STM_WCMAP_Parts_Search extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_STM_WCMAP_Icon_Filter extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_STM_WCMAP_AP_Info_Box extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_STM_WCMAP_AP_Icon_Box extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_STM_WCMAP_AP_Tabs extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_Stm_Apt_Ta_Tabs extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_Stm_WCMAP_Special_Product extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_Stm_WCMAP_Products_List extends WPBakeryShortCode {
    }
    class WPBakeryShortCode_Stm_WCMAP_Compare extends WPBakeryShortCode {
    }

}

if(function_exists('vc_add_shortcode_param')) vc_add_shortcode_param('stm_autocomplete_vc', 'stm_wcmap_autocomplete_vc_st_taxonomies', STM_WCMAP_URL . '/inc/vc_extends/jquery-ui.min.js');
function stm_wcmap_autocomplete_vc_st_taxonomies($settings, $value)
{
    return '<div class="stm_wcmap_autocomplete_vc_field">'
        . '<script type="text/javascript">'
        . 'var st_vc_taxonomies = ' . json_encode(stm_wcmap_get_taxonomies())
        . '</script>'
...
if(class_exists('WpbakeryShortcodeParams')) vc_add_shortcode_param('stm_datepicker_vc', 'stm_datepicker_vc_st_ap', STM_WCMAP_URL . '/assets/js/datepicker.js');
...
if(class_exists('WpbakeryShortcodeParams')) vc_add_shortcode_param('stm_timepicker_vc', 'stm_timepicker_vc_st_ap', STM_WCMAP_URL . '/assets/js/timepicker.js');
