...
<div class="stm-wcmap-ap-icon-box <?php echo esc_attr($css_class); ?>">
    <?php if(!empty($image)) : $img = wp_get_attachment_image_src($image, 'full'); ?>
    ...
    <div class="stm-wcmap-text-wrap">
        ...
        <div class="content"><?php echo apply_filters('stm_wcmap_ap_icon_box_content_filter', $content); ?></div>
    </div>
</div>
