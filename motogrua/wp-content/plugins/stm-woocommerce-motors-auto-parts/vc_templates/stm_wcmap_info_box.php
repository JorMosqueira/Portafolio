...
?>
    ...
    <div class="stm-wcmap-info-box <?php echo esc_attr($css_class); ?>" <?php echo apply_filters('stm_wcmap_ib_style_filter', $box_bg_style); ?>>
        <div class="inner" <?php echo apply_filters('stm_wcmap_ib_bg_filter', $image); ?>>
            <?php if (!empty($title)): ?>
                <div class="title heading-font" <?php echo apply_filters('stm_wcmap_ib_title_filter', $title_color); ?>><?php echo esc_attr($title); ?></div>
            <?php endif; ?>

            <?php if (!empty($price_value)): ?>
                <div class="stm-ap-price heading-font" <?php echo apply_filters('stm_wcmap_ib_price_filter', $price_style); ?>>
