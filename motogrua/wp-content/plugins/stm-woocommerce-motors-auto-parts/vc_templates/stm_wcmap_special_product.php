...
$secondary_color = get_theme_mod('site_style_secondary_color', '#6f9ae2');
$custom_css = "
            ...
            <div class="stm-spec-prod-text-info">
                ...
                <?php if ( !empty( $product_id ) ): ?>
                    <div class="special_offer_product__meta">
                        <h5 class="woocommerce-loop-product__title no_line heading-title"><a
                                    href="<?php echo get_permalink( $product_id ); ?>"><?php echo get_the_title( $product_id ); ?></a>
                        </h5>
                        <div class="price heading-title">
                            <?php echo apply_filters('stm_wmap_price_filter', $product->get_price_html()); ?>
                        </div>
                    </div>
                <?php endif; ?>
