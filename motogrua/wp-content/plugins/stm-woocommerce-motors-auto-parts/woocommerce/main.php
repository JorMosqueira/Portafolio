...
$second_color = get_theme_mod('site_style_secondary_color', '#6f9ae2');
$custom_css = "
...
if ( is_singular( 'product' ) ) {
    $sp_sidebar_id = get_theme_mod( 'wcmap_single_product_sidebar', 768 );
    $sp_template = get_theme_mod( 'wcmap_single_product_template', 'template_1' );
    $sp_sidebar_position = ($sp_template == 'template_sidebar') ? get_theme_mod( 'wcmap_single_product_sidebar_position', 'left' ) : 'none';
...
?>
    ...
    <div class="container">
        <div class="row">
            ...
            echo apply_filters('stm_wcmap_content_before_filter', $stm_sidebar_layout_mode['content_before']);

            if($sp_template != 'template_1') woocommerce_breadcrumb(array('delimiter' => '<i class="fa fa-chevron-right"></i>'));
            ...
            echo apply_filters('stm_wcmap_content_after_filter', $stm_sidebar_layout_mode['content_after']);

            if ( $sp_sidebar_position != 'none' ) {
                echo apply_filters('stm_wcmap_sidebar_before_filter', $stm_sidebar_layout_mode['sidebar_before']);
                ?>
                ...
                echo apply_filters('stm_wcmap_sidebar_after_filter', $stm_sidebar_layout_mode['sidebar_after']);
            }
            ?>
...
<?php
    ...
    $sidebar_id = get_theme_mod( 'shop_sidebar',  768 );
    $sidebar_position = get_theme_mod( 'shop_sidebar_position', 'left' );
    ...
    if(!is_shop() && !is_product_category()) get_template_part( 'partials/title_box' );
?>

    <div class="container">
        <div class="row">

            <?php echo apply_filters('stm_wcmap_content_before_filter', $stm_sidebar_layout_mode['content_before']); ?>
            <?php
                if ( is_singular( 'product' ) ) {
            ...
            ?>
            <?php echo apply_filters('stm_wcmap_content_after_filter', $stm_sidebar_layout_mode['content_after']); ?>

            <?php echo apply_filters('stm_wcmap_sidebar_before_filter', $stm_sidebar_layout_mode['sidebar_before']); ?>
            <div class="stm-shop-sidebar-area">
                <?php
            ...
            <?php echo apply_filters('stm_wcmap_sidebar_after_filter', $stm_sidebar_layout_mode['sidebar_after']); ?>
