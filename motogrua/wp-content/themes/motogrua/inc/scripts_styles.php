...
function stm_load_theme_ss()
{
    ...
    if ( get_theme_mod( 'site_style', 'site_style_default' ) != 'site_style_default' and is_dir( $upload_dir['basedir'] . '/stm_uploads' ) ) {
        ...
        if ( file_exists( get_theme_file_path( '/assets/css/app-' . $layout . '.css' ) ) ) {
            wp_enqueue_style( 'stm-theme-style-css', get_theme_file_uri( '/assets/css/app.css' ), null, STM_THEME_VERSION, 'all' );
            wp_enqueue_style( 'stm-theme-style-' . $layout . '-css', get_theme_file_uri( '/assets/css/app-' . $layout . '.css' ), null, STM_THEME_VERSION, 'all' );
        } else {
            if ( $layout == 'boats' ) {
...
function stm_load_ulisting_theme_ss () {
	...
	if ( get_theme_mod( 'site_style', 'site_style_default' ) != 'site_style_default' and is_dir( $upload_dir['basedir'] . '/stm_uploads' ) ) {
		...
		wp_enqueue_style( 'stm-theme-style-css', get_theme_file_uri( '/assets/css/app-' . $layout . '.css' ), null, STM_THEME_VERSION, 'all' );
	}
}
...
if ( !function_exists( 'stm_motors_enqueue_scripts_styles' ) ) {
    function stm_motors_enqueue_scripts_styles( $fileName )
    {
    	...
    	if(get_theme_mod( 'site_style' ) != 'site_style_default' && strpos($fileName, 'stm_mm_top') !== false) return;
