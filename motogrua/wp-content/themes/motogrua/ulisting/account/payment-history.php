	...
	<table class="table ulisting-table">
		...
		<?php foreach ( $payments as $payment ):?>
			<tr>
				...
				<td><?php echo stm_convert_date_format($payment->created_date).' '.stm_convert_time_format($payment->created_date)?></td>
				<td><?php echo stm_convert_date_format($payment->updated_date).' '.stm_convert_time_format($payment->updated_date)?></td>
			</tr>
		<?php endforeach;?>
		</tbody>
	</table>
